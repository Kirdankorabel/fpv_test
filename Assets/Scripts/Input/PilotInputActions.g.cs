...
//     version 1.19.0
//     from Assets/Settings/Input/Pilot.inputactions
//
...
{
    /// <summary>
    /// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Settings/Input/Pilot.inputactions".
    /// </summary>
    /// <remarks>
    ...
    /// </code>
    /// </example>
    public partial class @PilotInputActions: IInputActionCollection2, IDisposable
    {
        /// <summary>
    ...
    ""maps"": [
        {
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""c0000000-0000-4000-8000-000000000701"",
                ...
                {
                    ""name"": """",
                    ""id"": ""c0000000-0000-4000-8000-000000000702"",
                ...
                {
                    ""name"": """",
                    ""id"": ""c0000000-0000-4000-8000-000000000703"",
                ...
                {
                    ""name"": """",
                    ""id"": ""c0000000-0000-4000-8000-000000000704"",
                ...
                {
                    ""name"": """",
                    ""id"": ""c0000000-0000-4000-8000-000000000705"",
                ...
                {
                    ""name"": """",
                    ""id"": ""c0000000-0000-4000-8000-000000000706"",
    ...
    ""controlSchemes"": []
            ...
            m_Pilot_Yaw = m_Pilot.FindAction("Yaw", throwIfNotFound: true);
            m_Pilot_Pitch = m_Pilot.FindAction("Pitch", throwIfNotFound: true);
            m_Pilot_Roll = m_Pilot.FindAction("Roll", throwIfNotFound: true);
            m_Pilot_Arm = m_Pilot.FindAction("Arm", throwIfNotFound: true);
            m_Pilot_Respawn = m_Pilot.FindAction("Respawn", throwIfNotFound: true);
        }

        ~@PilotInputActions()
        {
            UnityEngine.Debug.Assert(!m_Pilot.enabled, "This will cause a leak and performance issues, PilotInputActions.Pilot.Disable() has not been called.");
        }
        ...
        private readonly InputAction m_Pilot_Yaw;
        private readonly InputAction m_Pilot_Pitch;
        private readonly InputAction m_Pilot_Roll;
        private readonly InputAction m_Pilot_Arm;
        private readonly InputAction m_Pilot_Respawn;
        /// <summary>
        /// Provides access to input actions defined in input action map "Pilot".
        /// </summary>
        public struct PilotActions
        {
            private @PilotInputActions m_Wrapper;

            /// <summary>
            /// Construct a new instance of the input action map wrapper class.
            /// </summary>
            public PilotActions(@PilotInputActions wrapper) { m_Wrapper = wrapper; }
            /// <summary>
            /// Provides access to the underlying input action "Pilot/Throttle".
            /// </summary>
            public InputAction @Throttle => m_Wrapper.m_Pilot_Throttle;
            /// <summary>
            /// Provides access to the underlying input action "Pilot/Yaw".
            /// </summary>
            public InputAction @Yaw => m_Wrapper.m_Pilot_Yaw;
            /// <summary>
            ...
            /// <summary>
            /// Provides access to the underlying input action "Pilot/Arm".
            /// </summary>
            public InputAction @Arm => m_Wrapper.m_Pilot_Arm;
            /// <summary>
            /// Provides access to the underlying input action "Pilot/Respawn".
            /// </summary>
            public InputAction @Respawn => m_Wrapper.m_Pilot_Respawn;
            /// <summary>
